      ...
      <div className="pb-16 md:pb-4">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center md:pb-12">
          ...
          <p className="mt-4 text-xl text-slate-500">
            Get <span className="font-extrabold">paid</span> for passing along
            business to service professionals in your network.
          </p>
        </div>
        ...
        >
          <Link
            className="group flex flex-col rounded-2xl bg-gradient-to-tr from-[#0ba5e9] to-[#37ACDE] p-5 pt-10 text-center text-white shadow-2xl"
          ...
          >
            ...
            <div className="mb-2 mt-1 text-xl font-black tracking-tighter">
              Real Estate Agent
            </div>
          ...
          <Link
            className="group flex flex-col rounded-2xl bg-gradient-to-tr from-[#8b5cf6] to-[#936ceb] p-5 pt-10 text-center text-white shadow-2xl"
          ...
          >
            ...
            <div className="text-xl opacity-80">I am a</div>
            <div className="mb-2 mt-1 grow text-xl font-black tracking-tighter">
              Home Contractor
            </div>
            <ArrowRightIcon className="h-6 w-6 -translate-x-2 self-end stroke-2 transition duration-150 ease-in-out group-hover:translate-x-0" />
          </Link>
          <Link
            className="group flex flex-col rounded-2xl bg-gradient-to-tr from-[#f471b6] to-[#f098c7] p-5 pt-10 text-center text-white shadow-2xl"
            href="/event-planner"
            data-aos="fade-down"
            data-aos-anchor="[data-aos-id-featbl]"
            data-aos-delay="200"
          ...
          <Link
            className="group flex flex-col rounded-2xl bg-gradient-to-tr from-[#3b81f6] to-[#90b1e6] p-5 pt-10 text-center text-white shadow-2xl"
            href="/coach"
            data-aos="fade-down"
            data-aos-anchor="[data-aos-id-featbl]"
            data-aos-delay="300"

    ...
    <section>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="relative">
          <Background />
          <div className="-mx-20 overflow-hidden px-20 py-12 md:py-20">
            <div className="items-start lg:flex">
              <Left />
              {/* Right content */}
              <div className="lg:ml-12 lg:w-[640px] xl:ml-20">
                <div className="space-y-12 lg:space-y-20">
                  ...
                  <div className="flex items-start">
                    ...
                    />
                    <div>
                      <div className="font-hkgrotesk text-lg font-extrabold text-slate-100">
                        Samantha James
                      </div>
                      <div className="mb-2">
                        <a
                          className="font-hkgrotesk text-sm font-medium text-blue-500 hover:underline"
                          href="#0"
                        >
                          @samyjames
                        </a>
                      ...
                      <div className="text-slate-400">
                        Samantha is a startup founder who loves to learn from
                        successful makers and teach others how they can achieve
                        similar success.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <div className="text-slate-400">
                        Quentin is a startup founder who loves to learn from
                        successful makers and teach others how they can achieve
                        similar success.
                      </div>
                    </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <div className="text-slate-400">
                        Natascha is a startup founder who loves to learn from
                        successful makers and teach others how they can achieve
                        similar success.
                      </div>
                    </div>
...
function Background() {
  return (
    <>
      <div
        className="absolute inset-0 -z-10 -mx-20 rounded-3xl bg-slate-900"
        aria-hidden="true"
      >
        {" "}
      </div>
      {/* Sparkles */}
      <div
        className="pointer-events-none absolute left-1/2 top-0 -z-10 mt-14 hidden -translate-x-1/2 lg:block"
        aria-hidden="true"
      >
      ...
      {/* Scratches */}
      <div
        className="pointer-events-none absolute left-1/2 top-full -z-10 -mt-4 -translate-x-1/2"
        aria-hidden="true"
      >
...
function Left() {
  return (
    <div className="mb-12 flex-1 lg:mb-0">
      <div className="mb-6">
        <h2 className="font-hkgrotesk mb-2 text-3xl font-extrabold text-slate-100 md:text-4xl">
          How it Works
        </h2>

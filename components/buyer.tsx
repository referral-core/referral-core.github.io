    ...
    <section id="buyer" className="relative mx-auto mb-20 max-w-6xl px-4 py-12 sm:px-6 md:py-20">
      <div className="pb-16 md:pb-4">
        ...
        <div className="mx-auto grid max-w-xs gap-4 sm:max-w-none sm:grid-cols-2 md:max-w-xl lg:max-w-none lg:grid-cols-3 lg:gap-6" data-aos-id-featbl>
          <div className="group flex flex-col rounded-2xl bg-gradient-to-tr from-[#0ba5e9] to-[#37ACDE] p-5 py-10 text-center text-white shadow-2xl" data-aos="fade-down" data-aos-anchor="[data-aos-id-featbl]">
          ...
          <div className="group flex flex-col rounded-2xl bg-gradient-to-tr from-[#8b5cf6] to-[#936ceb] p-5 py-10 text-center text-white shadow-2xl" data-aos="fade-down" data-aos-anchor="[data-aos-id-featbl]" data-aos-delay="100">
          ...
          <div className="group flex flex-col rounded-2xl bg-gradient-to-tr from-[#f471b6] to-[#f098c7] p-5 py-10 text-center text-white shadow-2xl" data-aos="fade-down" data-aos-anchor="[data-aos-id-featbl]" data-aos-delay="200">

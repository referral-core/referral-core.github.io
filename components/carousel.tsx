          ...
          <div className="-mx-20 overflow-hidden px-20 py-12 md:py-20">
            ...
            <div className="carousel swiper-container">
              <div className="swiper-wrapper">
                {/* Carousel items */}
                <div className="swiper-slide group flex h-auto max-w-[446px] flex-col">
                  <a href="#0">
                    <div className="group-odd:rotate-1 group-even:-rotate-1">
                      ...
                      <div className="p-5 pb-14">
                        <div className="font-hkgrotesk mb-1 text-xl font-extrabold leading-tight text-white">
                          Sick Leave for Indie Founders?
                        </div>
                        <div className="font-hkgrotesk mb-4 text-sm font-medium text-white opacity-80">
            ...
            <div className="mt-12 flex justify-end space-x-3">
              <button className="carousel-prev group relative z-20 flex h-11 w-11 items-center justify-center rounded-full bg-white transition duration-150 ease-in-out hover:bg-blue-100">
                <span className="sr-only">Previous</span>
                <svg
                  className="h-4 w-4 fill-blue-500 transition duration-150 ease-in-out"
                  viewBox="0 0 16 16"
              ...
              <button className="carousel-next group relative z-20 flex h-11 w-11 items-center justify-center rounded-full bg-white transition duration-150 ease-in-out hover:bg-blue-100">
